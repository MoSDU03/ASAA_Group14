...
\begin{itemize}
    ...
    \item \textit{Measure:} 600ms $\leq$ cycle time $\leq$ 1500ms
\end{itemize}
...
\begin{itemize}
    ...
    \item \textit{Measure:} Response time \textless 50ms
\end{itemize}
...
NFR-05 & Rel & Fault detection: \textless 200ms \\
NFR-06 & Safety & Emergency response: \textless 50ms \\
NFR-07 & Rel & Success rate: \textgreater 99\% \\
\hline
\end{tabular}
\end{table}
