...
We use UPPAAL's CTL query language where \ABox\ means “for all paths always,”
\EAng\ means “there exists a path where eventually,”
and \AAng\ means “for all paths eventually.”
...
\hline
Q1  & \ABox\ \uppaaltt{not deadlock} & Satisfied \\
Q2  & \EAng\ \uppaaltt{FillController.Complete} & Satisfied \\
Q3  & \ABox\ \uppaaltt{Filling => fill_clock <= 3000} & Satisfied \\
Q4  & \ABox\ \uppaaltt{WaitPos => cycle_clock <= 200} & Satisfied \\
Q5  & \ABox\ \uppaaltt{Complete => level in [325,335]} & Satisfied \\
Q6  & \EAng\ \uppaaltt{Fault} & Satisfied \\
Q7  & \AAng\ \uppaaltt{Idle} & Satisfied \\
Q8  & \EAng\ \uppaaltt{(Complete AND cycle in [600,1500])} & Satisfied \\
Q9  & \ABox\ \uppaaltt{(!sensor AND Filling) => Fault} & Satisfied \\
Q10 & \ABox\ \uppaaltt{(timeout AND ClosingValve) => Fault} & Satisfied \\
\hline
\end{tabular}
\end{table}
