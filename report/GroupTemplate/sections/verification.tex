...
\hline
Q1  & \ABox\ not deadlock & Satisfied \\
Q2  & \EAng\ FillController.Complete & Satisfied \\
Q3  & \ABox\ Filling $\Rightarrow$ fill\_clock \LE\ 3000 & Satisfied \\
Q4  & \ABox\ WaitPos $\Rightarrow$ cycle\_clock \LE\ 200 & Satisfied \\
Q5  & \ABox\ Complete $\Rightarrow$ level in $[325,335]$ & Satisfied \\
Q6  & \EAng\ Fault & Satisfied \\
Q7  & \AAng\ Idle & Satisfied \\
Q8  & \EAng\ (Complete AND cycle in $[600,1500]$) & Satisfied \\
Q9  & \ABox\ (!sensor AND Filling) $\Rightarrow$ Fault & Satisfied \\
Q10 & \ABox\ (timeout AND ClosingValve) $\Rightarrow$ Fault & Satisfied \\
\hline
\end{tabular}
\end{table}
