...
\begin{itemize}
    ...
    \item \textit{WaitingPosition} -> \textit{Filling} [positionValid AND cycleTime \ensuremath{\leq} 200ms] / openValve()
    \item \textit{Filling} -> \textit{ClosingValve} [level \ensuremath{\geq} 325ml AND fillTime \ensuremath{\leq} 3000ms] / closeValve()
