...
\hline
Q1  & \texttt{A[] not deadlock} & Satisfied \\
Q2  & \texttt{E<> FillController.Complete} & Satisfied \\
Q3  & \texttt{A[] Filling => fill\_clock <= 3000} & Satisfied \\
Q4  & \texttt{A[] WaitPos => cycle\_clock <= 200} & Satisfied \\
Q5  & \texttt{A[] Complete => level in [325,335]} & Satisfied \\
Q6  & \texttt{E<> Fault} & Satisfied \\
Q7  & \texttt{A<> Idle} & Satisfied \\
Q8  & \texttt{E<> (Complete AND cycle in [600,1500])} & Satisfied \\
Q9  & \texttt{A[] (!sensor AND Filling) => Fault} & Satisfied \\
Q10 & \texttt{A[] (timeout AND ClosingValve) => Fault} & Satisfied \\
\hline
\end{tabular}
\end{table}
