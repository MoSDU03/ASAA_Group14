...
\hline
Q1  & \texttt{\ABox\ not deadlock} & Satisfied \\
Q2  & \texttt{\EAng\ FillController.Complete} & Satisfied \\
Q3  & \texttt{\ABox\ Filling => fill\_clock \LE\ 3000} & Satisfied \\
Q4  & \texttt{\ABox\ WaitPos => cycle\_clock \LE\ 200} & Satisfied \\
Q5  & \texttt{\ABox\ Complete => level in [325,335]} & Satisfied \\
Q6  & \texttt{\EAng\ Fault} & Satisfied \\
Q7  & \texttt{\AAng\ Idle} & Satisfied \\
Q8  & \texttt{\EAng\ (Complete AND cycle in [600,1500])} & Satisfied \\
Q9  & \texttt{\ABox\ (!sensor AND Filling) => Fault} & Satisfied \\
Q10 & \texttt{\ABox\ (timeout AND ClosingValve) => Fault} & Satisfied \\
\hline
\end{tabular}
\end{table}
