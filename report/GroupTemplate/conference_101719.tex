...
\begin{figure}[htbp]
\centering
\fbox{\parbox{0.45\textwidth}{\centering\vspace{1.5cm}
Feature Model Diagram\\
\includegraphics{figures/{feature_model.pdf}
\vspace{1.5cm}}}
...
\fbox{\parbox{0.45\textwidth}{\centering\vspace{1.5cm}
Component Diagram\\
\ \includegraphics{figures/{component_diagram.pdf}
\vspace{1.5cm}}}
...
\ \includegraphics{figures/{state_machines.pdf}
\vspace{1.5cm}}}
...
\fbox{\parbox{0.45\textwidth}{\centering\vspace{1.5cm}
Deployment Diagram\\
\ \includegraphics{figures/{figures/deployment_architecture.pdf}
\vspace{1.5cm}}}
...
\hline
Muhammed Ozcelik & Requirements elicitation, UPPAAL model design, formal verification (Q1-Q8), counter-example analysis, Docker implementation \\
\hline
Dan Ngo & SysML architecture design, state machine specification, Python implementation (fill controller), experiment design and execution \\
\hline
Dan Nguyen & Feature model, component diagrams, sensor simulator implementation, database schema, statistical analysis \\
\hline
Denisa Alicia Rissa & Literature review, architectural decisions documentation, empirical evaluation, results analysis, report writing \\
\hline
\end{tabular}
