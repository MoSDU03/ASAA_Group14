...
\usepackage{amsmath} % keep this once

% UPPAAL query symbols (safe for text + tables + hyperlinks)
...
% If hyperref is used, prevent bookmark/pdf-string crashes
...
% Hyperref safety (PDF strings / bookmarks)
\pdfstringdefDisableCommands{%
  \def<{}%
  \def>{}%
  \def\textless{<}%
...
\author{
    ...
    \IEEEauthorblockA{
        ...
        Odense, Denmark\\
        Email: \IEEEauthorrefmark{1} \textnormal{\{muuzc22,dango21,dangu22\}}@student.sdu.dk
    }
}
