...
% hyperref must be loaded before pdfstringdefDisableCommands
% --- hyperref: avoid xdvipdfmx "pdf_link_obj" crash on first run (no .aux) ---
\IfFileExists{main.aux}{
  \usepackage{hyperref}
}{
  \usepackage[draft]{hyperref} % no real PDF link objects created
}
